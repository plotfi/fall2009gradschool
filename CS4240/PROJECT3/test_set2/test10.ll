...
%main.bb0.tmp16 = load i8** %factorial.c
%main.bb0.tmp17 = load double* %factorial.m
call void@fact(double %main.bb0.tmp17)
%main.bb0.tmp18 = load {double}* @fact.retval
%main.bb0.tmp19 = extractvalue {double} %main.bb0.tmp18, 0
%main.bb0.tmp20 = call i8*@ftoa(double %main.bb0.tmp19)
%main.bb0.tmp21 = call i8*@stringcat(i8* %main.bb0.tmp16, i8* %main.bb0.tmp20)
%main.bb0.tmp22 = bitcast [5 x i8]* @print0 to i8*
call i32 (i8*, ...)* @printf(i8* %main.bb0.tmp22, i8* %main.bb0.tmp21)
br label %return
return:
ret void
br label %main.bb6
