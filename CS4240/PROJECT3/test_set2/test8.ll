...
@string0 = constant [26 x i8] c"The arguement passed is: \00"
@print0 = constant [5 x i8] c"%s\09\0A\00"
@string1 = constant [5 x i8] c"1234\00"
...
br label %third.bb3
third.bb3:
%third.bb3.tmp1 = bitcast [26 x i8]* @string0 to i8*
%third.bb3.tmp2 = load i8** %third.c
%third.bb3.tmp3 = call i8*@stringcat(i8* %third.bb3.tmp1, i8* %third.bb3.tmp2)
%third.bb3.tmp4 = bitcast [5 x i8]* @print0 to i8*
call i32 (i8*, ...)* @printf(i8* %third.bb3.tmp4, i8* %third.bb3.tmp3)
br label %return
return:
ret void
}
...
br label %main.bb0
main.bb0:
%main.bb0.tmp5 = load i8** %second.b
call void@third(i8* %main.bb0.tmp5)
br label %return
return:
ret void
%return.tmp7 = load i8** %first.a
call void@second(i8* %return.tmp7)
br label %return
return:
ret void
%return.tmp9 = bitcast [5 x i8]* @string1 to i8*
call void@first(i8* %return.tmp9)
ret i32 0
}
