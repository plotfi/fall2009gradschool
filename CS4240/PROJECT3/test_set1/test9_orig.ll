...
@string36 = constant [26 x i8] c"The arguement passed is: \00"
@print40 = constant [5 x i8] c"%s\09\0A\00"
@string37 = constant [5 x i8] c"1234\00"
define void @first(i1 %a) {
entry:
%first.a = alloca i1
store i1 %a, i1 %first.a
br label %first.bb41
first.bb41:
call void@second(i1 %first.bb41.tmp402)
br label %return
return:
ret void
}
define void @second(i1 %b) {
entry:
%second.b = alloca i1
store i1 %b, i1 %second.b
br label %second.bb42
second.bb42:
call void@third(i1 %second.bb42.tmp400)
br label %return
return:
ret void
}
...
br label %third.bb43
third.bb43:
%third.bb43.tmp396 = bitcast [26 x i8]* @string36 to i8*
%third.bb43.tmp397 = load i8** %third.c
%third.bb43.tmp398 = call i8*@stringcat(i8* %third.bb43.tmp396, i8* %third.bb43.tmp397)
%third.bb43.tmp399 = bitcast [5 x i8]* @print40 to i8*
call i32 (i8*, ...)* @printf(i8* %third.bb43.tmp399, i8* %third.bb43.tmp398)
br label %return
return:
ret void
}
...
br label %main.bb40
main.bb40:
%main.bb40.tmp404 = bitcast [5 x i8]* @string37 to i8*
call void@third(i8* %main.bb40.tmp404)
ret i32 0
}
